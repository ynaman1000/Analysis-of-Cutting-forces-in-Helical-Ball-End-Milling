...
dimOutput = 4      # output dimension
numDataPts = 455     # total number of data points
case = 1
assert case in [1, 2, 3], case
if case == 1:
    miniBatchSize = 440     # size of mini-batch used for training
...
if numHypParamSamples == 1:
    initLR = 1e-3          # initial learning rates
    ...
    L1 = 3                   # number of hidden layers with activation function
...
plt_99per_percent_dev = False    # for plotting 99th percentile percent deviation
save_99per_per_dev_data = False  # for saving data of 99th percentile percent deviation
